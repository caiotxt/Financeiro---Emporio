...
# ======================================================
# PUBLIC VERSION
# Financial fact table consolidation (generic)
# Business-sensitive metrics were intentionally removed.
# ======================================================

DATA_DIR = "data/monthly_reports"
DEFAULT_YEAR = 2025

FACT_SHEET = "CMV_by_SKU"

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "FACT_SKU_MONTHLY.xlsx")
...
if duplicates.any():
    raise ValueError("Duplicate SKU detected within the same period.")
